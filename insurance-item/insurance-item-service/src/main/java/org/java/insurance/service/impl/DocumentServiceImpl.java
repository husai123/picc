...
public class DocumentServiceImpl implements DocumentService {
    ...
    @Override
    public PageResult<Document> findByInsurance(Integer page, Integer limit, String insurance_id , String Type_id) {
        //使用pageHelper分页查询
        PageHelper.startPage(page,limit);
        ...
        if(!StringUtils.isEmpty(insurance_id)){
            //指定查询条件
            criteria.andEqualTo("Insurance_id",insurance_id);
        }else {
            System.out.println("没有insurance_id");
        }
        ...
        //分页查询  info对象，包含了分页的全部数据
        PageInfo info=new PageInfo(documentMapper.selectByExample(example));
